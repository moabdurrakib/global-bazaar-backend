                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="table-image">
                        <img
                          src="http://127.0.0.1:8000/uploads/products/06032022112640vS6vLlmYFPtRUWhN_450_450.jpg"
                          alt="product"
                        />
                      </td>
                      <td class="table-name"><h6>Mens Suglass</h6></td>
                      <td class="table-name"><h6>1</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                ...
                <table class="table-list">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="table-image">
                        <img
                          src="http://127.0.0.1:8000/uploads/products/06032022112641ok9feZKytgrXBJx3_450_450.jpg"
                          alt="product"
                        />
                      </td>
                      <td class="table-name"><h6>Men's Pant</h6></td>
                      <td class="table-name"><h6>1</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                ...
                <table class="table-list">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="table-name"><h6>2</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                      <th></th>
                ...
                <table class="table-list">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="table-image">
                        <img
                          src="http://127.0.0.1:8000/uploads/products/06202022121706yj3SXnXwMSaQBv7p_450_450.png"
                          alt="product"
                        />
                      </td>
                      <td class="table-name"><h6>Men's Pant</h6></td>
                ...
                <table class="table-list">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="table-name"><h6>Yamaha R15 Bike</h6></td>
                      <td class="table-name"><h6>5</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td class="table-serial"><h6>2</h6></td>
                      ...
                      <td class="table-name"><h6>Men's Pant</h6></td>
                      <td class="table-name"><h6>3</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td class="table-serial"><h6>3</h6></td>
                      ...
                      <td class="table-name"><h6>Girls Cloth</h6></td>
                      <td class="table-name"><h6>6</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td class="table-serial"><h6>4</h6></td>
                    ...
                    <tr>
                      ...
                      <td class="table-name"><h6>Et non.</h6></td>
                      <td class="table-name"><h6>11</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                      <th></th>
                ...
                <table class="table-list">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="table-name"><h6>Yamaha R15 Bike</h6></td>
                      <td class="table-name"><h6>4</h6></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td class="table-serial"><h6>2</h6></td>
